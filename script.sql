...
SELECT pg_catalog.setval('tbl_follower_f_id_seq', 67, true);
...
SELECT pg_catalog.setval('tbl_register_id_seq', 127, true);
...
SELECT pg_catalog.setval('tbl_tweet_t_id_seq', 124, true);
